...
raspisanie = (
    ...
    'Hfcgbcfybt', 'hfcgbcfybt', 'HFCGBCFYBT',
    'Raspisanie', 'raspisanie', 'RASPISANIE'
    )

bot = telebot.TeleBot('1774674419:AAGs90j0GONVGOMG2IxK81bSVIrJ6jA3DFo')
...
def callback_worker(call):
    if call.data == "this":
        ...
        OP = next_week
    bot.send_message(call.message.chat.id, OP);

while True:
    try:
      bot.polling(none_stop=True, interval=3)
    except Exception as e:
        bot.send_message('269854203', e)
        print(e)
        time.sleep(5)
